...
export const DEMO_USERS_FOR_UI: User[] = [
  {
    ...
    aboutMe: 'Lover of good books. Looking for someone to join my adventures. 🏔️☕',
    interests: 'Hiking, Reading, Photography, Travel, Coffee',
    lifestyle: 'Early bird, non-smoker, dog person.',
  ...
  },
  {
    ...
    aboutMe: 'Software engineer by day, musician by night. Let\'s find the best tacos in town. 🌮🎸',
    interests: 'Music, Coding, Foodie, Concerts, Sci-Fi Movies',
    lifestyle: 'Night owl, social drinker, cat owner.',
    ...
    aboutMe: 'Art student who spends too much time in museums. Probably covered in paint. 🎨',
    interests: 'Art, Museums, Painting, Indie Films, Vintage clothing',
    lifestyle: 'Vegetarian, loves tea, often found sketching.',
