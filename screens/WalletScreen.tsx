    ...
    return (
        ...
        <div className="absolute inset-0 bg-gray-100 dark:bg-black z-[80] flex flex-col">
            <header className="flex items-center p-4 border-b dark:border-gray-800 bg-white dark:bg-zinc-900">
                ...
                <h1 className="text-xl font-bold text-center flex-1 text-dark-gray dark:text-gray-200">My Wallet</h1>
            ...
            <main className="flex-1 p-4">
                ...
                <div className="mt-8">
                    <h2 className="font-bold text-lg dark:text-gray-200">Transaction History</h2>
                    <p className="text-center text-gray-500 dark:text-gray-400 mt-4">No transactions yet.</p>
                </div>
            </main>
        </div>
        </>
