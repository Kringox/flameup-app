...
const CommentScreen: React.FC<CommentScreenProps> = ({ post, currentUser, onClose, onViewProfile }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex flex-col justify-end" onClick={onClose}>
            ...
            {/* Drawer */}
            <div 
                className="bg-zinc-900 w-full h-[75vh] rounded-t-3xl shadow-2xl relative flex flex-col animate-slide-in-bottom border-t border-zinc-800"
            ...
            >
                ...
                {/* Input Area */}
                <div className="p-3 border-t border-zinc-800 bg-zinc-900 pb-[env(safe-area-inset-bottom)]">
